...
public class TimeRegistrationHandler : INotificationHandler<ProjectFileCreatedReturnTimeRegistrationExportRecords>
{
    private readonly ILogger<TimeRegistrationHandler> _logger;
    private readonly IntegrationSettings _integrationSettings;
    private readonly IAgentMessageSerializationHelper _agentMessageSerializationHelper;

    public TimeRegistrationHandler(
        ILogger<TimeRegistrationHandler> logger,
    ...
    public async Task Handle(ProjectFileCreatedReturnTimeRegistrationExportRecords notification, CancellationToken cancellationToken)
    {
        // define file paths
