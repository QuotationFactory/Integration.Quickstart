...
public class ProjectFilesHandler: INotificationHandler<ProjectFileCreated>
{
    private readonly ILogger<ProjectFilesHandler> _logger;
    private readonly IAgentMessageSerializationHelper _agentMessageSerializationHelper;
    private readonly IntegrationSettings _integrationSettings;
    private static readonly Random s_random = new();

    public ProjectFilesHandler(ILogger<ProjectFilesHandler> logger,
